-- ============================================================================
-- PATTERN 5: FEE TRANSPARENCY - USER ARCHETYPE FIELDS MIGRATION (ADAPTED)
-- ============================================================================
-- Migration: Add archetype, flexibility_score, spending_score to public.user
-- Version: 1.0
-- Date: 2026-01-30
-- ============================================================================
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'valid_archetype') THEN
        ALTER TABLE public.user
