...
|----------|------|--------|
| P0 | Add global thresholds | Quality gate |
| P0 | Add CI enforcement | Prevent regression |
| P1 | Add critical path overrides | Payment safety |
| P1 | Configure Codecov | PR feedback |
| P2 | Add reduced thresholds for UI | Realistic expectations |
