 ...
 * @param {number} params.combinedMarkup - Combined unit + site markup (0-1).
 * @param {number[]} params.unusedNightsDiscounts - Array of unused nights discounts (7 elements).
 * @param {number} [params.fullTimeDiscount=0.13] - Discount for 7-night stays.
 * @returns {Array<number>} 7-element array of multipliers.
 *
