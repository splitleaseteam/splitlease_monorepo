 ...
 * @param {number} [params.unitMarkup=0] - Individual listing markup (0-1).
 * @param {number} [params.siteMarkup=0.17] - Site-wide markup (0-1).
 * @returns {number} Combined markup rate (0-1).
 *
