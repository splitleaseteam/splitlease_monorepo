 ...
 * @param {Array<number|null>} params.hostCompensation - 7-element array of host rates.
 * @param {Array<number>} params.multipliers - 7-element array of multipliers.
 * @returns {Array<number|null>} 7-element array of guest-facing nightly prices.
 *
...
export function calculateNightlyPricesArray({ hostCompensation, multipliers }) {
