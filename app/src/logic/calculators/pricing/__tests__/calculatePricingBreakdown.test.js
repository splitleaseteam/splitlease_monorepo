...
describe('calculatePricingBreakdown', () => {
  ...
  describe('complete pricing breakdown', () => {
    it('should calculate full breakdown for standard 4-night, 13-week stay', () => {
      const result = calculatePricingBreakdown({
        listing: {
          ...
          '💰Cleaning Cost / Maintenance Fee': 50,
          '💰Damage Deposit': 500
        },
        nightsPerWeek: 4,
        reservationWeeks: 13
    ...
    it('should calculate breakdown for 7-night, 52-week stay (full-time, full year)', () => {
      const result = calculatePricingBreakdown({
        listing: {
          '💰Nightly Host Rate for 7 nights': 80,
          '💰Cleaning Cost / Maintenance Fee': 100,
          '💰Damage Deposit': 1000
        },
        nightsPerWeek: 7,
        reservationWeeks: 52
    ...
    it('should calculate breakdown for minimum stay (2 nights, 4 weeks)', () => {
      const result = calculatePricingBreakdown({
        listing: {
          '💰Nightly Host Rate for 2 nights': 150,
          '💰Cleaning Cost / Maintenance Fee': 25,
          '💰Damage Deposit': 200
        },
        nightsPerWeek: 2,
        reservationWeeks: 4
  ...
  describe('missing optional fees', () => {
    it('should default cleaning fee to 0 when null', () => {
      const result = calculatePricingBreakdown({
        listing: {
          '💰Nightly Host Rate for 4 nights': 100,
          '💰Cleaning Cost / Maintenance Fee': null,
          '💰Damage Deposit': 500
        },
        nightsPerWeek: 4,
        reservationWeeks: 4
  ...
  describe('error handling - fee validation', () => {
    it('should throw error for NaN cleaning fee', () => {
      expect(() => calculatePricingBreakdown({
        listing: {
          '💰Nightly Host Rate for 4 nights': 100,
          '💰Cleaning Cost / Maintenance Fee': 'fifty'
        },
        nightsPerWeek: 4,
        reservationWeeks: 13
  ...
  describe('edge cases', () => {
    it('should handle minimum nights (2)', () => {
      const result = calculatePricingBreakdown({
        listing: { '💰Nightly Host Rate for 2 nights': 100 },
        nightsPerWeek: 2,
        reservationWeeks: 4
      });
    ...
    it('should handle maximum nights (7)', () => {
      const result = calculatePricingBreakdown({
        listing: { '💰Nightly Host Rate for 7 nights': 100 },
        nightsPerWeek: 7,
        reservationWeeks: 4
      });
    ...
    it('should handle decimal/float prices', () => {
      const result = calculatePricingBreakdown({
        listing: {
          ...
          '💰Cleaning Cost / Maintenance Fee': 49.99
        },
        nightsPerWeek: 4,
        reservationWeeks: 4
      });
  ...
  describe('real-world scenarios', () => {
    it('should calculate typical Mon-Thu 3-month stay', () => {
      const result = calculatePricingBreakdown({
        listing: {
          '💰Nightly Host Rate for 4 nights': 125,
          '💰Cleaning Cost / Maintenance Fee': 75,
          '💰Damage Deposit': 750
        },
        nightsPerWeek: 4,
        reservationWeeks: 13
    ...
    it('should calculate weekend getaway 1-month stay', () => {
      const result = calculatePricingBreakdown({
        listing: {
          '💰Nightly Host Rate for 2 nights': 200,
          '💰Cleaning Cost / Maintenance Fee': 40,
          '💰Damage Deposit': 300
        },
        nightsPerWeek: 2,
        reservationWeeks: 4
    ...
    it('should calculate full-time year-long stay', () => {
      const result = calculatePricingBreakdown({
        listing: {
          '💰Nightly Host Rate for 7 nights': 70,
          '💰Cleaning Cost / Maintenance Fee': 150,
          '💰Damage Deposit': 1500
        },
        nightsPerWeek: 7,
        reservationWeeks: 52
