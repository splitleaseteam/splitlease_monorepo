 ...
 *
 * @param {object} pricingList - Frontend pricing list object.
 * @returns {object} Adapted pricing list for Supabase.
 *
 ...
 * // }
 */
export function adaptPricingListForSupabase(pricingList) {
  if (!pricingList) {
  ...
  if (pricingList.rentalType !== undefined) {
    adapted['rental type'] = pricingList.rentalType;
  }
  ...
  if (pricingList.modifiedDate !== undefined) {
    adapted['Modified Date'] = pricingList.modifiedDate;
  }
