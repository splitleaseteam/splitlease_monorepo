...
export function isBiddingSession(obj: unknown): obj is BiddingSession {
    return (
        obj !== null &&
        typeof obj === 'object' &&
        'sessionId' in obj &&
        typeof (obj as BiddingSession).sessionId === 'string' &&
        'targetNight' in obj &&
        'status' in obj &&
        typeof (obj as BiddingSession).status === 'string'
    );
}
...
export function isBid(obj: unknown): obj is Bid {
    return (
        ...
        typeof obj === 'object' &&
        'bidId' in obj &&
        typeof (obj as Bid).bidId === 'string' &&
        'amount' in obj &&
        typeof (obj as Bid).amount === 'number' &&
        'placedAt' in obj
    );
}

export function isBiddingParticipant(obj: unknown): obj is BiddingParticipant {
    return (
        obj !== null &&
        typeof obj === 'object' &&
        'participantId' in obj &&
        typeof (obj as BiddingParticipant).participantId === 'string' &&
        'userId' in obj &&
        typeof (obj as BiddingParticipant).userId === 'string' &&
        'sessionId' in obj &&
        typeof (obj as BiddingParticipant).sessionId === 'string'
    );
}
