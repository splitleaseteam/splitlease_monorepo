...
\`\`\`jsx
import { ErrorModal } from 'islands/shared/ErrorModal';
...
\`\`\`
  ...
  argTypes: {
    errorInfo: {
      description: 'Error info object with hasError, errorType, and errorMessage',
      table: {
        type: { summary: 'object' },
      },
    },
