...
export default function DaysSelectionSection({ data, updateData, listing, zatConfig, errors = {} }) {
  ...
  const scheduleSelectorListing = useMemo(() => {
    ...
    return {
      ...
      lastAvailable: new Date(listing.first_available_date || Date.now()),
      numberOfNightsAvailable: listing.total_nights_available_per_week || 7,
      ...
      nightsAvailableList: [],
      nightsAvailableNumbers: listing.available_nights_as_day_numbers_json || [0, 1, 2, 3, 4, 5, 6],
      nightsNotAvailable: [],
  ...
  const handlePriceChange = (priceBreakdown) => {
    if (priceBreakdown && priceBreakdown.valid) {
      ...
      // This allows CreateProposalFlow to recalculate numberOfNights and firstFourWeeksTotal
