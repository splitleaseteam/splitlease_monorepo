/**
 * QuickMatchProposalCard Component
 *
 * Displays the guest's proposal details in a card format for hosts
 * reviewing incoming proposals at a glance in the Quick Match tool.
...
export function QuickMatchProposalCard({ proposal, isLoading }) {
  if (isLoading) {
    return (
