 ...
 * Maps UI display to database column base names in public.notification_preferences table
 *
 * Boolean schema: Each category has two columns (e.g., message_forwarding_email, message_forwarding_sms)
 * The hook transforms these booleans into arrays for UI compatibility: ['Email', 'SMS']
 */
