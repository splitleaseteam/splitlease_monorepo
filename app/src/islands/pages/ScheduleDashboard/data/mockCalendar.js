export const MOCK_CALENDAR_OWNERSHIP = {
  ...
  // Sarah (user-456): Fri-Sun pattern
  'user-456': [
...
export const MOCK_PENDING_NIGHTS = ['2026-02-14'];
export const MOCK_BLOCKED_NIGHTS = [];
export const MOCK_SHARED_NIGHTS = [];
