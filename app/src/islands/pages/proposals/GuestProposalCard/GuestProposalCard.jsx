/**
 * GuestProposalCard Component
 *
 * Guest proposals dashboard detailed card view with two-column layout:
...
export default function GuestProposalCard({ proposal, statusConfig, buttonConfig, allProposals = [], onProposalSelect, onProposalDeleted }) {
  // ============================================================================
  ...
  if (typeof daysSelected === 'string') {
    try {
      ...
      console.warn('GuestProposalCard: Failed to parse guest_selected_days_numbers_json:', _e);
      daysSelected = [];
    }
  }
