/**
 * HostProposalCardHeader Component (V7 Design)
 *
 * Host-side collapsed proposal card header showing:
...
/**
 * HostProposalCardHeader displays the collapsed state of a host-side proposal card
 *
 * @param {Object} props
 ...
 */
export function HostProposalCardHeader({ proposal, isExpanded, onToggle, contentId }) {
...
export default HostProposalCardHeader;
