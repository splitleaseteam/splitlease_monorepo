...
| **ErrorOverlay** | `shared/ErrorOverlay.jsx` | Error modal display |
...
| **CreateProposalFlowV2** | `shared/CreateProposalFlowV2.jsx` | Booking wizard |
...
| **CancelProposalModal** | `modals/CancelProposalModal.jsx` | Cancel confirmation |
