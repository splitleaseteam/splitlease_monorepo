...
var require_cjs = __commonJS({
  "node_modules/motion-utils/dist/cjs/index.js"(exports) {
    ...
    function addUniqueItem3(arr, item) {
      if (arr.indexOf(item) === -1)
        arr.push(item);
    }
    function removeItem6(arr, item) {
    ...
    var MotionGlobalConfig9 = {};
    var isNumericalString3 = (v) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(v);
    function isObject3(value) {
      return typeof value === "object" && value !== null;
    }
    var isZeroValueString3 = (v) => /^0[^.\s]+$/u.test(v);
    function memo5(callback) {
      let result;
      return () => {
        if (result === void 0)
          result = callback();
    ...
    var pipe6 = (...transformers) => transformers.reduce(combineFunctions);
    var progress7 = (from, to, value) => {
      const toFromDifference = to - from;
      return toFromDifference === 0 ? 1 : (value - from) / toFromDifference;
    };
    var SubscriptionManager4 = class {
      constructor() {
        this.subscriptions = [];
      }
      add(handler) {
        addUniqueItem3(this.subscriptions, handler);
        return () => removeItem6(this.subscriptions, handler);
      }
      notify(a, b, c) {
    ...
    var secondsToMilliseconds12 = (seconds) => seconds * 1e3;
    var millisecondsToSeconds7 = (milliseconds) => milliseconds / 1e3;
    function velocityPerSecond4(velocity, frameDuration) {
      return frameDuration ? velocity * (1e3 / frameDuration) : 0;
    }
    var warned = /* @__PURE__ */ new Set();
    function hasWarned2(message) {
      return warned.has(message);
    }
    function warnOnce8(condition, message, errorCode) {
    ...
    var backInOut2 = mirrorEasing(backIn);
    var anticipate2 = (p) => (p *= 2) < 1 ? 0.5 * backIn(p) : 0.5 * (2 - Math.pow(2, -10 * (p - 1)));
    var circIn = (p) => 1 - Math.sin(Math.acos(p));
    var circOut2 = reverseEasing(circIn);
    var circInOut2 = mirrorEasing(circIn);
    var easeIn = cubicBezier(0.42, 0, 1, 1);
    var easeOut = cubicBezier(0, 0, 0.58, 1);
    var easeInOut2 = cubicBezier(0.42, 0, 0.58, 1);
    function steps(numSteps, direction = "end") {
      return (progress8) => {
        ...
        return clamp10(0, 1, rounded / numSteps);
      };
    }
    var isEasingArray2 = (ease2) => {
      return Array.isArray(ease2) && typeof ease2[0] !== "number";
    };
    function getEasingForSegment3(easing, i) {
      return isEasingArray2(easing) ? easing[wrap2(0, easing.length, i)] : easing;
    }
    var isBezierDefinition3 = (easing) => Array.isArray(easing) && typeof easing[0] === "number";
    var easingLookup = {
      linear: noop13,
      easeIn,
    ...
    var easingDefinitionToFunction3 = (definition) => {
      if (isBezierDefinition3(definition)) {
    ...
    exports.MotionGlobalConfig = MotionGlobalConfig9;
    exports.SubscriptionManager = SubscriptionManager4;
    exports.addUniqueItem = addUniqueItem3;
    exports.anticipate = anticipate2;
    exports.backIn = backIn;
    exports.backInOut = backInOut2;
    exports.backOut = backOut;
    exports.circIn = circIn;
    exports.circInOut = circInOut2;
    exports.circOut = circOut2;
    exports.clamp = clamp10;
    exports.cubicBezier = cubicBezier;
    exports.easeIn = easeIn;
    exports.easeInOut = easeInOut2;
    exports.easeOut = easeOut;
    exports.easingDefinitionToFunction = easingDefinitionToFunction3;
    exports.getEasingForSegment = getEasingForSegment3;
    exports.hasWarned = hasWarned2;
    exports.isBezierDefinition = isBezierDefinition3;
    exports.isEasingArray = isEasingArray2;
    exports.isNumericalString = isNumericalString3;
    exports.isObject = isObject3;
    exports.isZeroValueString = isZeroValueString3;
    exports.memo = memo5;
    exports.millisecondsToSeconds = millisecondsToSeconds7;
    exports.mirrorEasing = mirrorEasing;
    exports.moveItem = moveItem2;
    exports.noop = noop13;
    exports.pipe = pipe6;
    exports.progress = progress7;
    exports.removeItem = removeItem6;
    exports.reverseEasing = reverseEasing;
    exports.secondsToMilliseconds = secondsToMilliseconds12;
    exports.steps = steps;
    exports.velocityPerSecond = velocityPerSecond4;
    exports.warnOnce = warnOnce8;
    exports.wrap = wrap2;
  }
});
...
__export(es_exports, {
  ...
  MotionGlobalConfig: () => import_motion_utils75.MotionGlobalConfig,
  ...
  acceleratedValues: () => acceleratedValues2,
  ...
  getAnimatableNone: () => getAnimatableNone2,
...
var import_motion_utils24 = __toESM(require_cjs(), 1);

// node_modules/motion-dom/dist/es/frameloop/sync-time.mjs
var import_motion_utils3 = __toESM(require_cjs(), 1);

// node_modules/motion-dom/dist/es/frameloop/frame.mjs
var import_motion_utils2 = __toESM(require_cjs(), 1);

// node_modules/motion-dom/dist/es/frameloop/batcher.mjs
var import_motion_utils = __toESM(require_cjs(), 1);
...
function createRenderBatcher(scheduleNextBatch, allowKeepAlive) {
  ...
  const processBatch = () => {
    const timestamp = import_motion_utils.MotionGlobalConfig.useManualTiming ? state.timestamp : performance.now();
    runNextFrame = false;
    if (!import_motion_utils.MotionGlobalConfig.useManualTiming) {
...
// node_modules/motion-dom/dist/es/frameloop/frame.mjs
var { schedule: frame, cancel: cancelFrame, state: frameData, steps: frameSteps } = createRenderBatcher(typeof requestAnimationFrame !== "undefined" ? requestAnimationFrame : import_motion_utils2.noop, true);
...
var time = {
  now: () => {
    if (now === void 0) {
      time.set(frameData.isProcessing || import_motion_utils3.MotionGlobalConfig.useManualTiming ? frameData.timestamp : performance.now());
    }
    return now;
  },
  set: (newTime) => {
...
var import_motion_utils15 = __toESM(require_cjs(), 1);
...
var import_motion_utils7 = __toESM(require_cjs(), 1);
...
var import_motion_utils5 = __toESM(require_cjs(), 1);

// node_modules/motion-dom/dist/es/value/types/numbers/index.mjs
var import_motion_utils4 = __toESM(require_cjs(), 1);
var number = {
...
var alpha = {
  ...number,
  transform: (v) => (0, import_motion_utils4.clamp)(0, 1, v)
};
var scale = {
  ...number,
  default: 1
...
// node_modules/motion-dom/dist/es/value/types/color/rgba.mjs
var clampRgbUnit = (v) => (0, import_motion_utils5.clamp)(0, 255, v);
var rgbUnit = {
  ...number,
...
var import_motion_utils6 = __toESM(require_cjs(), 1);
...
var mixNumber = (from, to, progress7) => {
  return from + (to - from) * progress7;
};
...
function asRGBA(color2) {
  ...
  (0, import_motion_utils6.warning)(Boolean(type), `'${color2}' is not an animatable color. Use the equivalent color code instead.`, "color-not-animatable");
  if (!Boolean(type))
    return false;
...
var mixComplex = (origin, target) => {
  ...
  if (canInterpolate) {
    ...
    return (0, import_motion_utils7.pipe)(mixArray(matchOrder(originStats, targetStats), targetStats.values), template);
  } else {
    (0, import_motion_utils7.warning)(true, `Complex values '${origin}' and '${target}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`, "complex-values-different");
...
var import_motion_utils11 = __toESM(require_cjs(), 1);
...
var import_motion_utils8 = __toESM(require_cjs(), 1);
function createGeneratorEasing(options, scale2 = 100, createGenerator) {
  ...
  return {
    type: "keyframes",
    ease: (progress7) => {
      return generator.next(duration * progress7).value / scale2;
    },
    duration: (0, import_motion_utils8.millisecondsToSeconds)(duration)
  };
}

// node_modules/motion-dom/dist/es/animation/generators/utils/velocity.mjs
var import_motion_utils9 = __toESM(require_cjs(), 1);
var velocitySampleDuration = 5;
function calcGeneratorVelocity(resolveValue, t, current2) {
  const prevT = Math.max(t - velocitySampleDuration, 0);
  return (0, import_motion_utils9.velocityPerSecond)(current2 - resolveValue(prevT), t - prevT);
}
...
var import_motion_utils10 = __toESM(require_cjs(), 1);
var safeMin = 1e-3;
function findSpring({ duration = springDefaults.duration, bounce = springDefaults.bounce, velocity = springDefaults.velocity, mass = springDefaults.mass }) {
  let envelope;
  let derivative;
  (0, import_motion_utils10.warning)(duration <= (0, import_motion_utils10.secondsToMilliseconds)(springDefaults.maxDuration), "Spring duration must be 10 seconds or less", "spring-duration-limit");
  let dampingRatio = 1 - bounce;
  dampingRatio = (0, import_motion_utils10.clamp)(springDefaults.minDamping, springDefaults.maxDamping, dampingRatio);
  duration = (0, import_motion_utils10.clamp)(springDefaults.minDuration, springDefaults.maxDuration, (0, import_motion_utils10.millisecondsToSeconds)(duration));
  if (dampingRatio < 1) {
  ...
  duration = (0, import_motion_utils10.secondsToMilliseconds)(duration);
...
function getSpringOptions(options) {
  ...
  if (!isSpringType(options, physicsKeys) && isSpringType(options, durationKeys)) {
    if (options.visualDuration) {
      ...
      const damping = 2 * (0, import_motion_utils11.clamp)(0.05, 1, 1 - (options.bounce || 0)) * Math.sqrt(stiffness);
      springOptions = {
        ...springOptions,
        mass: springDefaults.mass,
        stiffness,
...
function spring(optionsOrVisualDuration = springDefaults.visualDuration, bounce = springDefaults.bounce) {
  ...
  const { stiffness, damping, mass, duration, velocity, isResolvedFromDuration } = getSpringOptions({
    ...options,
    velocity: -(0, import_motion_utils11.millisecondsToSeconds)(options.velocity || 0)
  });
  const initialVelocity = velocity || 0;
  const dampingRatio = damping / (2 * Math.sqrt(stiffness * mass));
  const initialDelta = target - origin;
  const undampedAngularFreq = (0, import_motion_utils11.millisecondsToSeconds)(Math.sqrt(stiffness / mass));
  ...
  const generator = {
    ...
    next: (t) => {
      ...
      if (!isResolvedFromDuration) {
        ...
        if (dampingRatio < 1) {
          currentVelocity = t === 0 ? (0, import_motion_utils11.secondsToMilliseconds)(initialVelocity) : calcGeneratorVelocity(resolveSpring, t, current2);
        }
    ...
    toString: () => {
      ...
      const easing = generateLinearEasing((progress7) => generator.next(calculatedDuration * progress7).value, calculatedDuration, 30);
...
spring.applyToOptions = (options) => {
  ...
  options.duration = (0, import_motion_utils11.secondsToMilliseconds)(generatorOptions.duration);
...
var import_motion_utils14 = __toESM(require_cjs(), 1);

// node_modules/motion-dom/dist/es/utils/interpolate.mjs
var import_motion_utils12 = __toESM(require_cjs(), 1);
function createMixers(output, ease2, customMixer) {
  const mixers = [];
  const mixerFactory = customMixer || import_motion_utils12.MotionGlobalConfig.mix || mix;
  const numMixers = output.length - 1;
  for (let i = 0; i < numMixers; i++) {
    let mixer = mixerFactory(output[i], output[i + 1]);
    if (ease2) {
      const easingFunction = Array.isArray(ease2) ? ease2[i] || import_motion_utils12.noop : ease2;
      mixer = (0, import_motion_utils12.pipe)(easingFunction, mixer);
    }
    mixers.push(mixer);
  }
  return mixers;
...
function interpolate(input, output, { clamp: isClamp = true, ease: ease2, mixer } = {}) {
  ...
  (0, import_motion_utils12.invariant)(inputLength === output.length, "Both input and output ranges must be the same length", "range-length");
  if (inputLength === 1)
    return () => output[0];
  ...
  const interpolator = (v) => {
    ...
    const progressInRange = (0, import_motion_utils12.progress)(input[i], input[i + 1], v);
    return mixers[i](progressInRange);
  };
  return isClamp ? (v) => interpolator((0, import_motion_utils12.clamp)(input[0], input[inputLength - 1], v)) : interpolator;
}

// node_modules/motion-dom/dist/es/animation/keyframes/offsets/fill.mjs
var import_motion_utils13 = __toESM(require_cjs(), 1);
function fillOffset(offset, remaining) {
  const min = offset[offset.length - 1];
  for (let i = 1; i <= remaining; i++) {
    const offsetProgress = (0, import_motion_utils13.progress)(0, remaining, i);
...
function defaultEasing(values, easing) {
  return values.map(() => easing || import_motion_utils14.easeInOut).splice(0, values.length - 1);
}
function keyframes({ duration = 300, keyframes: keyframeValues, times, ease: ease2 = "easeInOut" }) {
  const easingFunctions = (0, import_motion_utils14.isEasingArray)(ease2) ? ease2.map(import_motion_utils14.easingDefinitionToFunction) : (0, import_motion_utils14.easingDefinitionToFunction)(ease2);
  const state = {
    done: false,
...
var JSAnimation = class extends WithPromise {
  ...
  initAnimation() {
    ...
    if (generatorFactory !== keyframes) {
      (0, import_motion_utils15.invariant)(keyframes$1.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${keyframes$1}`, "spring-two-frames");
    }
    if (generatorFactory !== keyframes && typeof keyframes$1[0] !== "number") {
      this.mixKeyframes = (0, import_motion_utils15.pipe)(percentToProgress, mix(keyframes$1[0], keyframes$1[1]));
      keyframes$1 = [0, 100];
    }
  ...
  tick(timestamp, sample = false) {
    ...
    if (repeat) {
      const progress7 = Math.min(this.currentTime, totalDuration) / resolvedDuration;
      let currentIteration = Math.floor(progress7);
      let iterationProgress = progress7 % 1;
      if (!iterationProgress && progress7 >= 1) {
        iterationProgress = 1;
      }
      ...
      elapsed = (0, import_motion_utils15.clamp)(0, 1, iterationProgress) * resolvedDuration;
    }
  ...
  get duration() {
    return (0, import_motion_utils15.millisecondsToSeconds)(this.calculatedDuration);
  }
  get iterationDuration() {
    const { delay: delay2 = 0 } = this.options || {};
    return this.duration + (0, import_motion_utils15.millisecondsToSeconds)(delay2);
  }
  get time() {
    return (0, import_motion_utils15.millisecondsToSeconds)(this.currentTime);
  }
  set time(newTime) {
    var _a;
    newTime = (0, import_motion_utils15.secondsToMilliseconds)(newTime);
  ...
  set speed(newSpeed) {
    ...
    if (hasChanged) {
      this.time = (0, import_motion_utils15.millisecondsToSeconds)(this.currentTime);
    }
  }
  play() {
    var _a, _b;
...
var import_motion_utils21 = __toESM(require_cjs(), 1);

// node_modules/motion-dom/dist/es/animation/NativeAnimation.mjs
var import_motion_utils19 = __toESM(require_cjs(), 1);
...
var import_motion_utils16 = __toESM(require_cjs(), 1);
var supportsScrollTimeline = (0, import_motion_utils16.memo)(() => window.ScrollTimeline !== void 0);

// node_modules/motion-dom/dist/es/animation/waapi/easing/map-easing.mjs
var import_motion_utils18 = __toESM(require_cjs(), 1);

// node_modules/motion-dom/dist/es/utils/supports/memo.mjs
var import_motion_utils17 = __toESM(require_cjs(), 1);
...
function memoSupports(callback, supportsFlag) {
  const memoized = (0, import_motion_utils17.memo)(callback);
...
function mapEasingToNativeEasing(easing, duration) {
  ...
  } else if ((0, import_motion_utils18.isBezierDefinition)(easing)) {
...
var NativeAnimation = class extends WithPromise {
  constructor(options) {
    ...
    this.options = options;
    (0, import_motion_utils19.invariant)(typeof options.type !== "string", `Mini animate() doesn't support "type" as a string.`, "mini-spring");
  ...
  get duration() {
    ...
    return (0, import_motion_utils19.millisecondsToSeconds)(Number(duration));
  }
  get iterationDuration() {
    const { delay: delay2 = 0 } = this.options || {};
    return this.duration + (0, import_motion_utils19.millisecondsToSeconds)(delay2);
  }
  get time() {
    return (0, import_motion_utils19.millisecondsToSeconds)(Number(this.animation.currentTime) || 0);
  }
  set time(newTime) {
    this.finishedTime = null;
    this.animation.currentTime = (0, import_motion_utils19.secondsToMilliseconds)(newTime);
  }
  /**
  ...
  attachTimeline({ timeline, observe }) {
    ...
    if (timeline && supportsScrollTimeline()) {
      ...
      return import_motion_utils19.noop;
    } else {
      return observe(this);
    }
  }
...
var import_motion_utils20 = __toESM(require_cjs(), 1);
var unsupportedEasingFunctions = {
  anticipate: import_motion_utils20.anticipate,
  backInOut: import_motion_utils20.backInOut,
  circInOut: import_motion_utils20.circInOut
};
...
var NativeAnimationExtended = class extends NativeAnimation {
  ...
  updateMotionValue(value) {
    ...
    const sampleTime = (0, import_motion_utils21.secondsToMilliseconds)(this.finishedTime ?? this.time);
...
var import_motion_utils22 = __toESM(require_cjs(), 1);
...
function canAnimate(keyframes2, name, type, velocity) {
  ...
  (0, import_motion_utils22.warning)(isOriginAnimatable === isTargetAnimatable, `You are trying to animate ${name} from "${originKeyframe}" to "${targetKeyframe}". "${isOriginAnimatable ? targetKeyframe : originKeyframe}" is not an animatable value.`, "value-not-animatable");
...
var import_motion_utils23 = __toESM(require_cjs(), 1);
...
var supportsWaapi = (0, import_motion_utils23.memo)(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
...
var AsyncMotionValueAnimation = class extends WithPromise {
  ...
  onKeyframesResolved(keyframes2, finalKeyframe, options, sync2) {
    ...
    if (!canAnimate(keyframes2, name, type, velocity)) {
      if (import_motion_utils24.MotionGlobalConfig.instantAnimations || !delay2) {
    ...
    animation.finished.then(() => this.notifyFinished()).catch(import_motion_utils24.noop);
...
var import_motion_utils25 = __toESM(require_cjs(), 1);
...
function getVariableValue(current2, element, depth = 1) {
  (0, import_motion_utils25.invariant)(depth <= maxDepth, `Max CSS variable fallback depth detected in property "${current2}". This may indicate a circular fallback dependency.`, "max-css-var-depth");
  ...
  if (resolved) {
    ...
    return (0, import_motion_utils25.isNumericalString)(trimmed) ? parseFloat(trimmed) : trimmed;
  }
...
var import_motion_utils26 = __toESM(require_cjs(), 1);
function isNone(value) {
  if (typeof value === "number") {
    return value === 0;
  } else if (value !== null) {
    return value === "none" || value === "0" || (0, import_motion_utils26.isZeroValueString)(value);
  } else {
    return true;
  }
}
...
var import_motion_utils27 = __toESM(require_cjs(), 1);
function isWaapiSupportedEasing(easing) {
  return Boolean(typeof easing === "function" && supportsLinearEasing() || !easing || typeof easing === "string" && (easing in supportedWaapiEasing || supportsLinearEasing()) || (0, import_motion_utils27.isBezierDefinition)(easing) || Array.isArray(easing) && easing.every(isWaapiSupportedEasing));
}

// node_modules/motion-dom/dist/es/animation/waapi/supports/partial-keyframes.mjs
var import_motion_utils28 = __toESM(require_cjs(), 1);
var supportsPartialKeyframes = (0, import_motion_utils28.memo)(() => {
  try {
...
var import_motion_utils29 = __toESM(require_cjs(), 1);
function isHTMLElement(element) {
  return (0, import_motion_utils29.isObject)(element) && "offsetHeight" in element;
}

// node_modules/motion-dom/dist/es/value/index.mjs
var import_motion_utils30 = __toESM(require_cjs(), 1);
...
var MotionValue = class {
  ...
  onChange(subscription) {
    if (true) {
      (0, import_motion_utils30.warnOnce)(false, `value.onChange(callback) is deprecated. Switch to value.on("change", callback).`);
    }
    return this.on("change", subscription);
  }
  on(eventName, callback) {
    if (!this.events[eventName]) {
      this.events[eventName] = new import_motion_utils30.SubscriptionManager();
    }
  ...
  getVelocity() {
    ...
    return (0, import_motion_utils30.velocityPerSecond)(parseFloat(this.current) - parseFloat(this.prevFrameValue), delta);
  }
  /**
...
var import_motion_utils31 = __toESM(require_cjs(), 1);
function isSVGElement(element) {
  return (0, import_motion_utils31.isObject)(element) && "ownerSVGElement" in element;
}
...
function observeTimeline(update, timeline) {
  ...
  const onFrame = () => {
    ...
    const progress7 = percentage / 100;
    if (prevProgress !== progress7) {
      update(progress7);
    }
    prevProgress = progress7;
  };
...
var import_motion_utils32 = __toESM(require_cjs(), 1);
...
function stagger(duration = 0.1, { startDelay = 0, from = 0, ease: ease2 } = {}) {
  return (i, total) => {
    ...
    if (ease2) {
      ...
      const easingFunction = (0, import_motion_utils32.easingDefinitionToFunction)(ease2);
...
var import_motion_utils35 = __toESM(require_cjs(), 1);

// node_modules/motion-dom/dist/es/view/queue.mjs
var import_motion_utils34 = __toESM(require_cjs(), 1);

// node_modules/motion-dom/dist/es/view/start.mjs
var import_motion_utils33 = __toESM(require_cjs(), 1);
    ...
    transition.ready.then(() => {
      ...
      targets.forEach((definition, target) => {
        for (const key of definitionNames) {
          ...
          for (let [valueName, valueKeyframes] of Object.entries(keyframes2)) {
            ...
            valueOptions.duration && (valueOptions.duration = (0, import_motion_utils33.secondsToMilliseconds)(valueOptions.duration));
            valueOptions.delay && (valueOptions.delay = (0, import_motion_utils33.secondsToMilliseconds)(valueOptions.delay));
      ...
      for (const animation of generatedViewAnimations) {
        ...
        if (!targetDefinition) {
          ...
          animationTransition.duration && (animationTransition.duration = (0, import_motion_utils33.secondsToMilliseconds)(animationTransition.duration));
          animationTransition = applyGeneratorOptions(animationTransition);
          const easing = mapEasingToNativeEasing(animationTransition.ease, animationTransition.duration);
          effect.updateTiming({
            delay: (0, import_motion_utils33.secondsToMilliseconds)(animationTransition.delay ?? 0),
...
function start(builder) {
  (0, import_motion_utils34.removeItem)(builders, builder);
  current = builder;
...
var ViewTransitionBuilder = class {
  constructor(update, options = {}) {
    ...
    this.notifyReady = import_motion_utils35.noop;
...
var import_motion_utils37 = __toESM(require_cjs(), 1);

// node_modules/framer-motion/dist/es/motion/index.mjs
var import_jsx_runtime7 = __toESM(require_jsx_runtime(), 1);
var import_motion_utils36 = __toESM(require_cjs(), 1);
...
function useStrictMode(configAndProps, preloadedFeatures) {
  ...
  if (preloadedFeatures && isStrict) {
    ...
    configAndProps.ignoreStrict ? (0, import_motion_utils36.warning)(false, strictMessage, "lazy-strict-mode") : (0, import_motion_utils36.invariant)(false, strictMessage, "lazy-strict-mode");
  }
}
...
function createMotionProxy(preloadedFeatures, createVisualElement) {
  ...
  const deprecatedFactoryFunction = (Component3, options) => {
    if (true) {
      (0, import_motion_utils37.warnOnce)(false, "motion() is deprecated. Use motion.create() instead.");
    }
...
var import_motion_utils38 = __toESM(require_cjs(), 1);
...
var VisualElement = class {
  ...
  mount(instance) {
    ...
    if (true) {
      (0, import_motion_utils38.warnOnce)(this.shouldReduceMotion !== true, "You have Reduced Motion enabled on your device. Animations may not appear as expected.", "reduced-motion-disabled");
    }
  ...
  readValue(key, target) {
    ...
    if (value !== void 0 && value !== null) {
      if (typeof value === "string" && ((0, import_motion_utils38.isNumericalString)(value) || (0, import_motion_utils38.isZeroValueString)(value))) {
  ...
  on(eventName, callback) {
    if (!this.events[eventName]) {
      this.events[eventName] = new import_motion_utils38.SubscriptionManager();
    }
...
var import_motion_utils39 = __toESM(require_cjs(), 1);
...
function addValueToWillChange(visualElement, key) {
  ...
  } else if (!willChange && import_motion_utils39.MotionGlobalConfig.WillChange) {
    const newWillChange = new import_motion_utils39.MotionGlobalConfig.WillChange("auto");
...
var import_motion_utils40 = __toESM(require_cjs(), 1);
...
var animateMotionValue = (name, value, target, transition = {}, element, isHandoff) => (onComplete) => {
  ...
  elapsed = elapsed - (0, import_motion_utils40.secondsToMilliseconds)(delay2);
  const options = {
  ...
  options.duration && (options.duration = (0, import_motion_utils40.secondsToMilliseconds)(options.duration));
  options.repeatDelay && (options.repeatDelay = (0, import_motion_utils40.secondsToMilliseconds)(options.repeatDelay));
  ...
  if (import_motion_utils40.MotionGlobalConfig.instantAnimations || import_motion_utils40.MotionGlobalConfig.skipAnimations) {
    shouldSkip = true;
    makeAnimationInstant(options);
    options.delay = 0;
  }
...
var import_motion_utils44 = __toESM(require_cjs(), 1);

// node_modules/framer-motion/dist/es/gestures/drag/VisualElementDragControls.mjs
var import_motion_utils43 = __toESM(require_cjs(), 1);
...
var import_motion_utils41 = __toESM(require_cjs(), 1);
...
var PanSession = class {
  constructor(event, handlers, { transformPagePoint, contextWindow = window, dragSnapToOrigin = false, distanceThreshold = 3 } = {}) {
    ...
    this.removeListeners = (0, import_motion_utils41.pipe)(addPointerEvent(this.contextWindow, "pointermove", this.handlePointerMove), addPointerEvent(this.contextWindow, "pointerup", this.handlePointerUp), addPointerEvent(this.contextWindow, "pointercancel", this.handlePointerUp));
  }
...
function getVelocity(history, timeDelta) {
  ...
  while (i >= 0) {
    ...
    if (lastPoint.timestamp - timestampedPoint.timestamp > (0, import_motion_utils41.secondsToMilliseconds)(timeDelta)) {
      break;
    }
    i--;
  }
  ...
  const time2 = (0, import_motion_utils41.millisecondsToSeconds)(lastPoint.timestamp - timestampedPoint.timestamp);
  if (time2 === 0) {
    return { x: 0, y: 0 };
  }
...
var import_motion_utils42 = __toESM(require_cjs(), 1);
...
function calcOrigin(source, target) {
  ...
  if (targetLength > sourceLength) {
    origin = (0, import_motion_utils42.progress)(target.min, target.max - sourceLength, source.min);
  } else if (sourceLength > targetLength) {
    origin = (0, import_motion_utils42.progress)(source.min, source.max - targetLength, target.min);
  }
  return (0, import_motion_utils42.clamp)(0, 1, origin);
}
...
var VisualElementDragControls = class {
  ...
  resolveRefConstraints() {
    ...
    (0, import_motion_utils43.invariant)(constraintsElement !== null, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.", "drag-constraints-ref");
    const { projection } = this.visualElement;
    if (!projection || !projection.layout)
      return false;
...
var DragGesture = class extends Feature {
  constructor(node) {
    super(node);
    this.removeGroupControls = import_motion_utils44.noop;
    this.removeListeners = import_motion_utils44.noop;
  ...
  mount() {
    ...
    this.removeListeners = this.controls.addListeners() || import_motion_utils44.noop;
  }
  unmount() {
...
var import_motion_utils45 = __toESM(require_cjs(), 1);
...
var PanGesture = class extends Feature {
  constructor() {
    super(...arguments);
    this.removePointerDownListener = import_motion_utils45.noop;
  }
...
var import_motion_utils50 = __toESM(require_cjs(), 1);
...
var import_motion_utils46 = __toESM(require_cjs(), 1);
...
var FlatTree = class {
  ...
  add(child) {
    (0, import_motion_utils46.addUniqueItem)(this.children, child);
    this.isDirty = true;
  }
  remove(child) {
    (0, import_motion_utils46.removeItem)(this.children, child);
    this.isDirty = true;
  }
  forEach(callback) {
...
var import_motion_utils47 = __toESM(require_cjs(), 1);
...
var import_motion_utils48 = __toESM(require_cjs(), 1);
var borders = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"];
var numBorders = borders.length;
var asNumber2 = (value) => typeof value === "string" ? parseFloat(value) : value;
var isPx = (value) => typeof value === "number" || px.test(value);
function mixValues(target, follow, lead, progress7, shouldCrossfadeOpacity, isOnlyMember) {
  if (shouldCrossfadeOpacity) {
    target.opacity = mixNumber(0, lead.opacity ?? 1, easeCrossfadeIn(progress7));
    target.opacityExit = mixNumber(follow.opacity ?? 1, 0, easeCrossfadeOut(progress7));
  } else if (isOnlyMember) {
    target.opacity = mixNumber(follow.opacity ?? 1, lead.opacity ?? 1, progress7);
  }
  for (let i = 0; i < numBorders; i++) {
    ...
    if (canMix) {
      target[borderLabel] = Math.max(mixNumber(asNumber2(followRadius), asNumber2(leadRadius), progress7), 0);
  ...
  if (follow.rotate || lead.rotate) {
    target.rotate = mixNumber(follow.rotate || 0, lead.rotate || 0, progress7);
  }
}
function getRadius(values, radiusName) {
  return values[radiusName] !== void 0 ? values[radiusName] : values.borderRadius;
}
var easeCrossfadeIn = compress(0, 0.5, import_motion_utils48.circOut);
var easeCrossfadeOut = compress(0.5, 0.95, import_motion_utils48.noop);
function compress(min, max, easing) {
  return (p) => {
    ...
    if (p > max)
      return 1;
    return easing((0, import_motion_utils48.progress)(min, max, p));
  };
}
...
var import_motion_utils49 = __toESM(require_cjs(), 1);
var NodeStack = class {
  constructor() {
    this.members = [];
  }
  add(node) {
    (0, import_motion_utils49.addUniqueItem)(this.members, node);
    node.scheduleRender();
  }
  remove(node) {
    (0, import_motion_utils49.removeItem)(this.members, node);
  ...
  return class ProjectionNode {
    ...
    addEventListener(name, handler) {
      if (!this.eventHandlers.has(name)) {
        this.eventHandlers.set(name, new import_motion_utils50.SubscriptionManager());
      }
    ...
    update() {
      ...
      this.clearAllSnapshots();
      const now2 = time.now();
      frameData.delta = (0, import_motion_utils50.clamp)(0, 1e3 / 60, now2 - frameData.timestamp);
    ...
    setAnimationOrigin(delta, hasOnlyRelativeTargetChanged = false) {
      ...
      this.mixTargetDelta = (latest) => {
        const progress7 = latest / 1e3;
        mixAxisDelta(targetDelta.x, delta.x, progress7);
        mixAxisDelta(targetDelta.y, delta.y, progress7);
        this.setTargetDelta(targetDelta);
        if (this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout) {
          calcRelativePosition(relativeLayout, this.layout.layoutBox, this.relativeParent.layout.layoutBox);
          mixBox(this.relativeTarget, this.relativeTargetOrigin, relativeLayout, progress7);
        ...
        if (isSharedLayoutAnimation) {
          ...
          mixValues(mixedValues, snapshotLatestValues, this.latestValues, progress7, shouldCrossfadeOpacity, isOnlyMember);
        }
        this.root.scheduleUpdateProjection();
        this.scheduleRender();
        this.animationProgress = progress7;
      };
...
var roundPoint = userAgentContains("applewebkit/") && !userAgentContains("chrome/") ? Math.round : import_motion_utils50.noop;
...
var import_motion_utils51 = __toESM(require_cjs(), 1);
var FocusGesture = class extends Feature {
  ...
  mount() {
    this.unmount = (0, import_motion_utils51.pipe)(addDomEvent(this.node.current, "focus", () => this.onFocus()), addDomEvent(this.node.current, "blur", () => this.onBlur()));
  }
  unmount() {
  }
};
...
var import_motion_utils58 = __toESM(require_cjs(), 1);

// node_modules/framer-motion/dist/es/value/use-scroll.mjs
var import_motion_utils57 = __toESM(require_cjs(), 1);
var import_react32 = __toESM(require_react(), 1);

// node_modules/framer-motion/dist/es/render/dom/scroll/index.mjs
var import_motion_utils56 = __toESM(require_cjs(), 1);

// node_modules/framer-motion/dist/es/render/dom/scroll/track.mjs
var import_motion_utils55 = __toESM(require_cjs(), 1);

// node_modules/framer-motion/dist/es/render/dom/scroll/info.mjs
var import_motion_utils52 = __toESM(require_cjs(), 1);
var maxElapsed2 = 50;
var createAxisInfo = () => ({
  current: 0,
  offset: [],
...
function updateAxisInfo(element, axisName, info, time2) {
  ...
  axis.progress = (0, import_motion_utils52.progress)(0, axis.scrollLength, axis.current);
  const elapsed = time2 - prevTime;
  axis.velocity = elapsed > maxElapsed2 ? 0 : (0, import_motion_utils52.velocityPerSecond)(axis.current - prev, elapsed);
}
...
var import_motion_utils54 = __toESM(require_cjs(), 1);

// node_modules/framer-motion/dist/es/render/dom/scroll/offsets/index.mjs
var import_motion_utils53 = __toESM(require_cjs(), 1);
...
function resolveOffsets(container, info, options) {
  ...
  info[axis].progress = (0, import_motion_utils53.clamp)(0, 1, info[axis].interpolate(info[axis].current));
}
...
function measure(container, target = container, info) {
  ...
  if (true) {
    if (container && target && target !== container) {
      (0, import_motion_utils54.warnOnce)(getComputedStyle(container).position !== "static", "Please ensure that the container has a non-static position, like 'relative', 'fixed', or 'absolute' to ensure scroll offset is calculated correctly.");
    }
  }
}
...
function scrollInfo(onScroll, { container = document.scrollingElement, ...options } = {}) {
  if (!container)
    return import_motion_utils55.noop;
...
function attachToAnimation(animation, options) {
  ...
  return animation.attachTimeline({
    ...
    observe: (valueAnimation) => {
      ...
      return observeTimeline((progress7) => {
        valueAnimation.time = valueAnimation.iterationDuration * progress7;
      }, timeline);
    }
  });
}
...
function scroll(onScroll, { axis = "y", container = document.scrollingElement, ...options } = {}) {
  if (!container)
    return import_motion_utils56.noop;
...
function useScroll({ container, target, ...options } = {}) {
  ...
  (0, import_react32.useEffect)(() => {
    if (needsStart.current) {
      (0, import_motion_utils57.invariant)(!isRefPending(container), "Container ref is defined but not hydrated", "use-scroll-ref");
      (0, import_motion_utils57.invariant)(!isRefPending(target), "Target ref is defined but not hydrated", "use-scroll-ref");
      return start2();
    } else {
      return;
    }
...
function useElementScroll(ref) {
  if (true) {
    (0, import_motion_utils58.warnOnce)(false, "useElementScroll is deprecated. Convert to useScroll({ container: ref }).");
  }
  return useScroll({ container: ref });
}

// node_modules/framer-motion/dist/es/value/scroll/use-viewport-scroll.mjs
var import_motion_utils59 = __toESM(require_cjs(), 1);
function useViewportScroll() {
  if (true) {
    (0, import_motion_utils59.warnOnce)(false, "useViewportScroll is deprecated. Convert to useScroll().");
  }
  return useScroll();
}
...
var import_motion_utils60 = __toESM(require_cjs(), 1);
var import_react36 = __toESM(require_react(), 1);
function useReducedMotion() {
  !hasReducedMotionListener.current && initPrefersReducedMotion();
  const [shouldReduceMotion] = (0, import_react36.useState)(prefersReducedMotion.current);
  if (true) {
    (0, import_motion_utils60.warnOnce)(shouldReduceMotion !== true, "You have Reduced Motion enabled on your device. Animations may not appear as expected.", "reduced-motion-disabled");
  }
...
// node_modules/framer-motion/dist/es/index.mjs
__reExport(es_exports, __toESM(require_cjs(), 1));
var import_motion_utils75 = __toESM(require_cjs(), 1);

// node_modules/framer-motion/dist/es/animation/hooks/animation-controls.mjs
var import_motion_utils61 = __toESM(require_cjs(), 1);
...
function animationControls() {
  ...
  const controls = {
    ...
    start(definition, transitionOverride) {
      (0, import_motion_utils61.invariant)(hasMounted, "controls.start() should only be called after a component has mounted. Consider calling within a useEffect hook.");
      const animations2 = [];
    ...
    set(definition) {
      (0, import_motion_utils61.invariant)(hasMounted, "controls.set() should only be called after a component has mounted. Consider calling within a useEffect hook.");
...
var import_motion_utils65 = __toESM(require_cjs(), 1);

// node_modules/framer-motion/dist/es/animation/sequence/create.mjs
var import_motion_utils63 = __toESM(require_cjs(), 1);
...
var import_motion_utils62 = __toESM(require_cjs(), 1);
function eraseKeyframes(sequence, startTime, endTime) {
  for (let i = 0; i < sequence.length; i++) {
    const keyframe = sequence[i];
    if (keyframe.at > startTime && keyframe.at < endTime) {
      (0, import_motion_utils62.removeItem)(sequence, keyframe);
      i--;
    }
  }
}
function addKeyframes(sequence, keyframes2, easing, offset, startTime, endTime) {
  ...
  for (let i = 0; i < keyframes2.length; i++) {
    sequence.push({
      ...
      easing: (0, import_motion_utils62.getEasingForSegment)(easing, i)
    });
  }
}
  ...
  for (let i = 0; i < sequence.length; i++) {
    ...
    const resolveValueSequence = (valueKeyframes, valueTransition, valueSequence, elementIndex = 0, numSubjects = 0) => {
      ...
      if (numKeyframes <= 2 && createGenerator) {
        ...
        if (duration !== void 0) {
          springTransition.duration = (0, import_motion_utils63.secondsToMilliseconds)(duration);
        }
      ...
      if (repeat) {
        (0, import_motion_utils63.invariant)(repeat < MAX_REPEAT, "Repeat count too high, must be less than 20", "repeat-count-high");
        ...
        for (let repeatIndex = 0; repeatIndex < repeat; repeatIndex++) {
          ...
          for (let keyframeIndex = 0; keyframeIndex < originalKeyframes.length; keyframeIndex++) {
            ...
            ease2.push(keyframeIndex === 0 ? "linear" : (0, import_motion_utils63.getEasingForSegment)(originalEase, keyframeIndex - 1));
          }
        }
  ...
  sequences.forEach((valueSequences, element) => {
    for (const key in valueSequences) {
      ...
      for (let i = 0; i < valueSequence.length; i++) {
        ...
        valueOffset.push((0, import_motion_utils63.progress)(0, totalDuration, at));
...
var import_motion_utils64 = __toESM(require_cjs(), 1);
...
function animateSubject(subject, keyframes2, options, scope) {
  ...
  if (isSingleValue(subject, keyframes2)) {
    ...
    const numSubjects = subjects.length;
    (0, import_motion_utils64.invariant)(Boolean(numSubjects), "No valid elements provided.", "no-valid-elements");
    for (let i = 0; i < numSubjects; i++) {
      const thisSubject = subjects[i];
      (0, import_motion_utils64.invariant)(thisSubject !== null, "You're trying to perform an animation on null. Ensure that selectors are correctly finding elements and refs are correctly hydrated.", "animate-null");
  ...
  function scopedAnimate(subjectOrSequence, optionsOrKeyframes, options) {
    ...
    if (scope) {
      ...
      animation.finished.then(() => {
        (0, import_motion_utils65.removeItem)(scope.animations, animation);
      });
    }
    return animation;
  }
...
var import_motion_utils66 = __toESM(require_cjs(), 1);
function animateElements(elementOrSelector, keyframes2, options, scope) {
  const elements = resolveElements(elementOrSelector, scope);
  const numElements = elements.length;
  (0, import_motion_utils66.invariant)(Boolean(numElements), "No valid elements provided.", "no-valid-elements");
  ...
  for (let i = 0; i < numElements; i++) {
    ...
    for (const valueName in keyframes2) {
      ...
      valueOptions.duration && (valueOptions.duration = (0, import_motion_utils66.secondsToMilliseconds)(valueOptions.duration));
      valueOptions.delay && (valueOptions.delay = (0, import_motion_utils66.secondsToMilliseconds)(valueOptions.delay));
...
var import_motion_utils67 = __toESM(require_cjs(), 1);
...
function useCycle(...items) {
  ...
  const runCycle = (0, import_react41.useCallback)(
    (next2) => {
      index.current = typeof next2 !== "number" ? (0, import_motion_utils67.wrap)(0, items.length, index.current + 1) : next2;
...
var import_motion_utils68 = __toESM(require_cjs(), 1);
  ...
  (0, import_react43.useEffect)(() => {
    frame.postRender(() => frame.postRender(() => {
      if (forcedRenderCount !== unlockOnFrameRef.current)
        return;
      import_motion_utils68.MotionGlobalConfig.instantAnimations = false;
    }));
  }, [forcedRenderCount]);
  return (callback) => {
    startInstantLayoutTransition(() => {
      import_motion_utils68.MotionGlobalConfig.instantAnimations = true;
      forceUpdate();
      callback();
...
var import_motion_utils69 = __toESM(require_cjs(), 1);
...
function startOptimizedAppearAnimation(element, name, keyframes2, options, onReady) {
  ...
  if (readyAnimation.ready) {
    readyAnimation.ready.then(startAnimation).catch(import_motion_utils69.noop);
  } else {
    startAnimation();
  }
}
...
var import_motion_utils70 = __toESM(require_cjs(), 1);
var React4 = __toESM(require_react(), 1);
var id3 = 0;
var AnimateSharedLayout = ({ children }) => {
  React4.useEffect(() => {
    (0, import_motion_utils70.invariant)(false, "AnimateSharedLayout is deprecated: https://www.framer.com/docs/guide-upgrade/##shared-layout-animations");
  }, []);
  return (0, import_jsx_runtime9.jsx)(LayoutGroup, { id: useConstant(() => `asl-${id3++}`), children });
};

// node_modules/framer-motion/dist/es/value/use-inverted-scale.mjs
var import_motion_utils71 = __toESM(require_cjs(), 1);
...
function useInvertedScale(scale2) {
  ...
  (0, import_motion_utils71.invariant)(!!(scale2 || visualElement), "If no scale values are provided, useInvertedScale must be used within a child of another motion component.");
  (0, import_motion_utils71.warning)(hasWarned, "useInvertedScale is deprecated and will be removed in 3.0. Use the layout prop instead.");
  hasWarned = true;
  if (scale2) {
...
var import_motion_utils73 = __toESM(require_cjs(), 1);
...
var import_motion_utils72 = __toESM(require_cjs(), 1);
function checkReorder(order, value, offset, velocity) {
  ...
  if (nextOffset === 1 && item.layout.max + offset > nextItemCenter || nextOffset === -1 && item.layout.min + offset < nextItemCenter) {
    return (0, import_motion_utils72.moveItem)(order, index, index + nextOffset);
  }
  return order;
}
...
function ReorderGroupComponent({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  (0, import_motion_utils73.invariant)(Boolean(values), "Reorder.Group must be provided a values prop", "reorder-values");
  const context = {
    axis,
...
var import_motion_utils74 = __toESM(require_cjs(), 1);
...
function ReorderItemComponent({ children, style: style2 = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  ...
  (0, import_motion_utils74.invariant)(Boolean(context), "Reorder.Item must be a child of Reorder.Group", "reorder-item-child");
...
var export_MotionGlobalConfig = import_motion_utils75.MotionGlobalConfig;
export {
  AnimatePresence,
  AnimateSharedLayout,
  ...
  MotionConfigContext,
  MotionContext,
  export_MotionGlobalConfig as MotionGlobalConfig,
  MotionValue,
  NativeAnimation,
